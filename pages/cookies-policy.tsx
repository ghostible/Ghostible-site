        ...
        <>
            <main className=" text-white min-h-screen px-4 py-20  policy_contact">
                <div className="max-w-2xl mx-auto">
                    ...
                    <h2 className="text-5xl md:text-2xl font-semibold mb-2">Cookies Policy</h2>
                    ...
                    <section className="mb-8">
                    <h2 className="text-5xl md:text-2xl font-semibold mb-2">What are cookies?</h2>
                    <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                    <h2 className="text-5xl md:text-2xl font-semibold mb-2">How we use cookies</h2>
                    ...
                    <section className="mb-8">
                    <h2 className="text-5xl md:text-2xl font-semibold mb-2">Managing cookies</h2>
                    <p className="text-gray-300">
