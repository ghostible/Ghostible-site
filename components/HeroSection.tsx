      ...
      <section className="hero-section">
        <div className="flex items-center justify-center  px-4">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-300" data-aos="fade-up"
            ...
            <div className="mt-6" data-aos="fade-up"
              ...
              <Link
                href="/tempnumber"
                className="bg-teal-400 text-black font-semibold py-4 px-8 rounded-full hover:bg-teal-300 transition cursor-pointer"
              >
                Get Started
              </Link>
            </div>
            <div className="mt-6 flex flex-wrap justify-center justify-items-start gap-4 text-sm">
              <p className="flex flex-wrap justify-center gap-3 align-center" data-aos="fade-up"
                 data-aos-duration="5000">
