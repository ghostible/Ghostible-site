...
import { MapPin, Zap, RefreshCw, Shield  } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="bg-cyan-500/10 hover:bg-cyan-500/20 text-teal-400 w-14 h-14 flex items-center justify-center rounded-full text-2xl mb-4">
             <MapPin size="30"/>
              </div>
