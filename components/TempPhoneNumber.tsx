      ...
      <div className="bg-[#111111] text-gray-800 font-sans">
        <section className="py-16 px-4 lg:w-5xl mx-auto text-center">
          ...
          <p className="text-white max-w-2xl mx-auto mb-12">
            Our virtual phone numbers are loved worldwide, check out the host of
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="group border rounded-lg p-6 transition-all duration-300 hover:shadow-xl  text-white hover:bg-blue-50 hover:text-[#000] cursor-pointer">
              ...
              <p className=" text-sm">
                Protect your privacy by using our thousands of disposable
            ...
            <div className="group border rounded-lg p-6 transition-all duration-300 hover:shadow-xl  text-white hover:bg-blue-50 hover:text-[#000] cursor-pointer">
              ...
              <p className=" text-sm">
                Long and short term rentals for all non-voip numbers. Never use
            ...
            <div className="group border rounded-lg p-6 transition-all duration-300 hover:shadow-xl  text-white hover:bg-blue-50 hover:text-[#000] cursor-pointer">
              ...
              <p className=" text-sm">
                All data is encrypted to ensure your privacy and protection from
                online companies.
              </p>
            </div>
            <div className="group border rounded-lg p-6 transition-all duration-300 hover:shadow-xl  text-white hover:bg-blue-50 hover:text-[#000] cursor-pointer">
              ...
              <p className="text-sm">
                Easily integrate our API and scale your app with secure phone
                number support.
              </p>
            </div>
          </div>
